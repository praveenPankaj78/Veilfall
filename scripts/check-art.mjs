...
assert.ok(
  new Set(allArt.map((art) => art.src)).size >= 70,
  'The shipped artwork set should not shrink below the 70 integrated plates',
);
...
assert.equal(artworkAssignmentKind(nodes['c5-grave-mouth']), 'override');
