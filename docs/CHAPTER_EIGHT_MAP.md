...
Canonical entry: `c8-gate-ring`

Location: the eight fort defence ring surrounding the Black Gate

Immediate objective: restore the fortress chain before the yearly opening becomes an invasion road
...
No decision in this chapter changes either absent hero's main plot.
...
Benefit: seven forts receive enough stored strength to hold without devil aid or full staffing.

Risk: the ring gains a permanent physical gap and First Fort is destroyed.

The route still lets the player decide whether evidence, wounded people, or both escape the collapse.
...
`blackgate`: the ring and colossal Gate establish geography.

`futureless`: the occupied fort and breach show the human cost.

`embassy`: Vexa and the first public crossing mark the climax.

No art from Chapters One through Seven is reused.
