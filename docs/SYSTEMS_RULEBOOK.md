...
- Health starts at 8 and fuels physical actions.
...
- Health returns through food, rest, medicine, or surrendering the pace of pursuit.
...
- Health starts at 8. Physical tricks, wounds, and desperate escapes can reduce it.
...
- Setup is earned by observing, planting, rehearsing, or learning an expectation. It belongs to the current location or plan and is spent on Stage choices.
- Echoes record lives borrowed through Glimmer. Some provide knowledge while others distort identity.

Recovery:

- Health returns through rest, treatment, surrendering speed, or accepting help.
...
- Setup does not recover. Rook must create new Setup in the next scene.

### Ilyra

- Health starts at 8. Wounds and severe magical backlash reduce it.
...
- Leverage is a named opportunity tied to one person, such as Korran's pride or Tomas's need to publish the truth. It is discovered through observation and Threadread, then spent to redirect a conversation or bargain.
...
- Health returns through physical treatment and rest. Reducing Strain does not automatically heal a wound.
- Spent Memory Shards do not return automatically. A rare recovery always changes the memory or costs something else.

## Health, danger, and death
...
Later systems may allow one clearly signalled rescue through a companion, Oath, spell, or Luck. Such a rescue must have been prepared before the lethal choice and must create a lasting cost such as injury, capture, debt, or the companion's loss. It is never a hidden safety net.
...
- Costs 2 Health
- Gains 1 Heat
- Spends the Setup: False Funeral
- Uses the Leverage: His Fear of Public Shame
...
- prevent one lethal result only when the rescue source and permanent consequence were shown before the choice.
...
4. Low class resources create altered approaches. Zero Health creates a clearly presented death rather than a dead end disguised as progress.
