# Chapter Five Map: The Dragon's Cold Grave

## Player promise

The player leaves the shifting roads and enters a physically clear mountain adventure. Cold fire follows warmth, the Crown is already digging into a dragon grave, and every step upward makes retreat harder.
...
1. Cross the first valley after learning that cold fire follows living heat.
2. Rescue Sorin from a glass slab before the fire reaches him.
3. Choose what to learn or reveal inside the unheated shelter.
4. Investigate or evade the Regent's abandoned survey camp.
...
13. Witness Orivane's willing sacrifice and understand the concealed cost.
14. Save people or evidence when the grave collapses.
...
Caelan cuts out the ember. He gains direct power, but Vaor survives as an enemy and follows him east.
...
- `public/art/dragonspine-coldfire.webp` covers the glass-valley arrival and, until a unique plate exists, the grave door.
- `public/art/dragonspine-royal-drill.webp` covers the abandoned royal camp.
- `public/art/dragonspine-upper-fork.webp` covers the upper valley fork at `c5-three-climbs` and all three climbs after that choice.
...
- every Chapter Five node is reachable;
- all routes contain exactly fifteen decisions;
- all three endings are reachable;
- Chapter Five contains a reachable lethal choice;
